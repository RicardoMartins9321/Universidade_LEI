// Generated from /home/ricardo/Universidade/Compiladores/Exames/MinhaResolucao_BigIntCalc/BigIntCalc.g4 by ANTLR 4.13.1
...
public class BigIntCalcParser extends Parser {
	...
	public static final int
		...
		T__9=10, T__10=11, INT=12, ID=13, COMMENT=14, WS=15, NEWLINE=16, ERROR=17;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INT", "ID", "COMMENT", "WS", "NEWLINE", "ERROR"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 12852L) != 0)) {
				{
				{
				setState(12);
				statement();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(39);
						((ExprMultDivContext)_localctx).e2 = expr(4);
						}
						break;
					case 2:
						{
						...
						setState(42);
						((ExprAddSubContext)_localctx).e2 = expr(3);
						}
						break;
					case 3:
						{
						_localctx = new ExprModuleContext(new ExprContext(_parentctx, _parentState));
						((ExprModuleContext)_localctx).e1 = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(43);
						...
						match(T__7);
						setState(45);
						((ExprModuleContext)_localctx).e2 = expr(2);
						}
						break;
					}
					} 
