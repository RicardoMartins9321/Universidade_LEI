...
Para fazer as funções mais complicadas dá para criar o cógigo que é independente das posições x e y e apenas se precisa de preocupar com o Numero de linhas e Numero de coluna
