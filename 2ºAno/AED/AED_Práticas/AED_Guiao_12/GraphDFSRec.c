...
void _displayGraphDFSRec(const GraphDFSRec* p, unsigned int vertex) {
  Stack* s = GraphDFSRecPathTo(p, vertex);

  printf("DFS Path starting from vertex %d: ", vertex);
