...
public class POO2021 {

	public static void main(String[] args) throws FileNotFoundException {
		PrintStream fl = new PrintStream(new File("Testes/POO_2021_ExamePrático/POO_2021C.txt"));
	...
	private static void alinea2(PrintStream out) {
		...
		Scanner input = null;
		try {
			input = new Scanner(new File("Testes/POO_2021_ExamePrático/uafest.txt"));
