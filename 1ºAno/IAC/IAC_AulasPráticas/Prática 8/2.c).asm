	.data
prompt1:.asciiz "Introduza um texto em maiusculas: "
result:	.asciiz "Input transformado em minusculas: "
input:	.space 20
	.text
...
while:				# while (minus[i] != ‘\0’)
	...
	add $t1, $t1, 32	# convert from uppercase to lowercase
...
nexti:	addi $t0, $t0, 1	# i++
	...
	la $a0, input		# $a0 = texto_minusculas
	syscall
