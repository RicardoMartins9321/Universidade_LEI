            ...
            if (localStorage.fav.length != 0) {
                ...
                $("#table-favourites").append(
                    `<tr id="fav-${i}">
                        ...
                        <td class="text-end">
                            <a class="btn btn-default btn-outline-danger btn-sm btn-favourite" onclick="removeFav(${i})"><i class="fa fa-heart text-danger" title="Selecione para remover dos favoritos"></i></a>
                        </td>
                    </tr>`
                )
        ...
        if (localStorage.fav2.length != 0) {
            ...
            $("#table-favourites2").append(
                `<tr id="fav2-${i}">
                        ...
                        <td class="text-end">
                            <a class="btn btn-default btn-outline-danger btn-sm btn-favourite" onclick="removeFav2(${i})"><i class="fa fa-heart text-danger" title="Selecione para remover dos favoritos"></i></a>
                        </td>
                    </tr>`
            )
        ...
        if (localStorage.fav3.length != 0) {
            ...
            $("#table-favourites3").append(
                `<tr id="fav3-${i}">
                        ...
                        <td class="text-end">
                            <a class="btn btn-default btn-outline-danger btn-sm btn-favourite" onclick="removeFav3(${i})"><i class="fa fa-heart text-danger" title="Selecione para remover dos favoritos"></i></a>
                        </td>
                    </tr>`
            )
        ...
        if (localStorage.fav4.length != 0) {
            ...
            $("#table-favourites4").append(
                `<tr id="fav4-${i}">
                        ...
                        <td class="text-end">
                            <a class="btn btn-default btn-outline-danger btn-sm btn-favourite" onclick="removeFav4(${i})"><i class="fa fa-heart text-danger" title="Selecione para remover dos favoritos"></i></a>
                        </td>
                    </tr>`
            )
        ...
        if (localStorage.fav5.length != 0) {
            ...
            $("#table-favourites5").append(
                `<tr id="fav5-${i}">
                        ...
                        <td class="align-middle">${data.Name}</td>
                        <td class="text-end">
                            <a class="btn btn-default btn-outline-danger btn-sm btn-favourite" onclick="removeFav5(${i})"><i class="fa fa-heart text-danger" title="Selecione para remover dos favoritos"></i></a>
                        </td>
                    </tr>`
            )
